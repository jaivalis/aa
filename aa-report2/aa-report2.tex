...
\section{Discussion}
Having conducted the previous experiments we now have obtained a wide overview of some interesting learning algorithms. In this section we will provide a comparisson of those by plotting the best performing combination of each of those in a plot. Figure \ref{} illustrates a concentrated overview of all the algorithms.\\
