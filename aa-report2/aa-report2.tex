...
\begin{tikzpicture}
\begin{axis}[xlabel={$\alpha$},ylabel={Average Length}]

\addplot table[x index=0,y index=1,col sep=comma] {discountvsalpha.dat};
\addlegendentry{$\gamma$=0.1}% y index+1 since humans count from 1
